...
namespace Repository.Context
{
    public static partial class ContextExtensions
    {
        ...
        private static IEnumerable<string> Return(DbContext context, Type clrEntityType)
        {
        ...
        {
            var collection = Return(context, clrEntityType);
